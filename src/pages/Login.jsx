...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (data.user) {
                navigate('/dashboard'); // Assuming there's a dashboard or home page
            }
        } catch (err) {
    ...
    return (
        ...
        >
            <form className="space-y-6" onSubmit={handleLogin}>
                ...
                <div>
                    ...
                    <div className="text-right mt-2">
                        <Link to="#" className="text-sm text-secondary hover:text-accent transition-colors">Forgot Password?</Link>
                    </div>
                </div>
                <button
                    type="submit"
            ...
            <div className="relative my-8 text-center">
                ...
                <span className="relative px-4 bg-dark-card text-sm text-text-muted uppercase tracking-wider">Or continue with</span>
            </div>
            ...
            <p className="text-center mt-10 text-text-muted">
                Don't have an account? <Link to="/signup" className="text-secondary hover:text-accent font-medium transition-colors">Create Account</Link>
            </p>
        </AuthLayout>
    );
};
